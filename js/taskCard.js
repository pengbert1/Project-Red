...
<div class="card" style="width: 18rem;">
    <div class="card-body">
        ...
        <p class="card-text" id="status">Task Status</p>
        <p class="card-text" id="goalDuration">Task Goal Duration</p>
        <p class="card-text" id="timeElasped">Time Elasped:</p>
        <button id="completeButton">
            <img src="assets/images/blue-check.jpg" style="width: 50px; height: 50px; border-radius: 50%;">
        </button>
        
        
        
        <button id="deleteButton">
            <img src="assets/images/red-x.png" style="width: 50px; height: 50px; border-radius: 50%;">
        </button>
        
        <button id = "timerButton">
            <img src="assets/images/timer.png" style="width: 50px; height: 50px; border-radius: 50%;">
        </button>
    </div>
</div>
`;
